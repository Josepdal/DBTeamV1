...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		set_text(LANG, 'noStickersT', 'Stickers are not allowed in this Group.')
		set_text(LANG, 'stickersT', 'Stickers are now allowed in this Group.')

		set_text(LANG, 'gifsT', 'Gifs are now allowed in this Group.')
		set_text(LANG, 'noGifsT', 'Gifs are not allowed in this Group.')

		set_text(LANG, 'photosT', 'Photos are now allowed in this Group.')
		set_text(LANG, 'noPhotosT', 'Photos are not allowed in this Group.')

		set_text(LANG, 'arabicT', 'Arabic is now allowed in this Group.')
		set_text(LANG, 'noArabicT', 'Arabic is not allowed in this Group.')
		
		set_text(LANG, 'audiosT', 'Audios are now allowed in this Group.')
		set_text(LANG, 'noAudiosT', 'Audios are not allowed in this Group.')

		set_text(LANG, 'kickmeT', 'Autokick is now allowed in this Group.')
		set_text(LANG, 'noKickmeT', 'Autokick is not allowed in this Group.')

		set_text(LANG, 'floodT', 'Flood is now allowed in this Group.')
		set_text(LANG, 'noFloodT', 'Flood is not allowed in this Group.')
		...
		set_text(LANG, 'lockMembersT', 'The number of members has been locked on this Group.')
		set_text(LANG, 'notLockMembersT', 'The number of members now is not locked on this Group.')
