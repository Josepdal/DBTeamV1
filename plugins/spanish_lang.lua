...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		-- giverank.lua --
		set_text(LANG, 'require_sudo', 'Este plugin requiere permisos de sudo.')
		set_text(LANG, 'require_admin', 'Exte plugin requiere permisos de admin o superior.')
		set_text(LANG, 'require_mod', 'Este plugin requiere permisos de mod o superior.')
