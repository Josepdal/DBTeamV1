...
local function run(msg, matches)
	if permissions(msg.from.id, msg.to.id, "lang_install") then
		...
		-- welcome.lua
		set_text(LANG, 'weloff', 'Bemvinda ativada.')
		set_text(LANG, 'welon', 'Bemvinda desativada')
		set_text(LANG, 'byeon', 'Despedida ativada.')
		set_text(LANG, 'byeoff', 'Despedida desativada.')
		set_text(LANG, 'welcome1', 'Olá ')
		set_text(LANG, 'welcome2', 'bemvindo para ')
		set_text(LANG, 'weldefault', 'Bemvinda ativada é o omissão.')
		set_text(LANG, 'byedefault', 'Despedida  ativada é o omissão.')
		set_text(LANG, 'newbye', 'Despedida salva. é:')
		set_text(LANG, 'bye1', 'Adeus ')
		set_text(LANG, 'bye2', ' obrigado por a visita.')
		set_text(LANG, 'welnew', 'Bemvinda salva. é:')
		...
		set_text(LANG, 'noTgservicesT', 'Os Serviços do Telegram foram silenciados neste grupo.')
		set_text(LANG, 'noTgservicesL', 'Os Serviços do Telegram foram silenciados neste supergrupo.')
		set_text(LANG, 'tgservicesT', 'Os Serviços do Telegram foram permitidos neste grupo.')
		set_text(LANG, 'tgservicesL', 'Os Serviços do Telegram foram permitidos neste supergrupo.')
		
		
		set_text(LANG, 'LinksT', 'Os links são permitidos no grupo.')
		set_text(LANG, 'LinksL', 'Os links são permitidos no supergrupo.')
		set_text(LANG, 'noLinksT', 'Os links não são permitidos no grupo.')
		set_text(LANG, 'noLinksL', 'Os links não são permitidos no supergrupo.')
		...
		set_text(LANG, 'botsT', 'Bots são permitidos neste grupo.')
		set_text(LANG, 'botsL', 'Bots são permitidos neste supergrupo.')
		set_text(LANG, 'noBotsT', 'Bots não são permitidos neste grupo.')
		...
		set_text(LANG, 'chatSetphoto', 'Agora você pode ajustar a foto neste grupo.')
		set_text(LANG, 'channelSetphoto', 'Agora você pode ajustar a foto neste supergrupo.')
		set_text(LANG, 'notChatSetphoto', 'Agora você não pode ajustar foto neste grupo.')
		set_text(LANG, 'notChannelSetphoto', 'Agora você não pode ajustar foto neste supergrupo.')
		set_text(LANG, 'setPhotoError', 'Por favor, habilite a configuração do setphoto.')
		...
		set_text(LANG, 'userUnmuted:2', 'permitido para falar.')
		...
		set_text(LANG, 'gbanUser:2', 'banido globalmente.')
		...
		-- rules.lua --
		set_text(LANG, 'setRules', 'As regras do grupo foram atualizadas.')
		set_text(LANG, 'remRules', 'As regras do grupo foram removidas.')
		...
		set_text(LANG, 'id:4', '#id <user_name>: Retorna o ID membro do nome de usuário do bate-papo atual.')
		...
		set_text(LANG, 'moderation:5', '#kickme: Sair.')
		...
		set_text(LANG, 'settings:0', 20)
	  	...
	  	set_text(LANG, 'settings:8', '#settings kickme enable/disable: Os usuários poderão usar o /kickme quando estiver ativo.')
	  	...
	  	set_text(LANG, 'settings:13', '#settings floodtime <segundos>: Ele define o tempo de medição de flood.')
	  	set_text(LANG, 'settings:14', '#settings maxflood <segundos>: Define a mensagem máximo em um tempo de floodtempo devem ser considerados flood.')
	  	set_text(LANG, 'settings:15', '#setname <titulo do grupo>: O bot renomeia o nome do grupo.')
	  	set_text(LANG, 'settings:16', '#setphoto <depois envie a imagem>: O bot muda a foto do grupo.')
		...
		set_text(LANG, 'settings:20', '#settings tgservices enable/disable: Quando desativado, a notificação de um novo participante será apagado.')
